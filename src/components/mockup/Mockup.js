...
import phone1 from "../../assets/asset 6.octet-stream";
import phone2 from "../../assets/asset 7.octet-stream";
import circles from "../../assets/asset 5.png";

export default function Mockup() {
  return (
    <section className="py-12 lg:py-[100px] bg-black py-8 relative">
      <img src={circles} alt="circles" className="absolute top-0 h-auto w-[70%]" />
